...
"C:\Program Files (x86)\Cypress\PSoC Creator\2.2\PSoC Creator\bin\cyvalidateide.exe" -dev CY8C5568AXI-060 -ide "%~1\%~3" -flsAddr 0x0 -flsSize 0x40000 -sramAddr 0x1FFF8000 -sramSize 0x10000
...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF EXIST "C:\Users\Aaron\Documents\PSoC Creator\Design02\Motor Sheild Module.cydsn\Motor Sheild Module.svd" "C:\Keil\UV4\SVDConv.exe" "C:\Users\Aaron\Documents\PSoC Creator\Design02\Motor Sheild Module.cydsn\Motor Sheild Module.svd" -o "C:\Users\Aaron\Documents\PSoC Creator\Design02\Motor Sheild Module.cydsn" --generate=sfr -n "Motor Sheild Module"
IF NOT EXIST "C:\Users\Aaron\Documents\PSoC Creator\Design02\Motor Sheild Module.cydsn\Motor Sheild Module.svd" rem "C:\Users\Aaron\Documents\PSoC Creator\Design02\Motor Sheild Module.cydsn\Motor Sheild Module.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
